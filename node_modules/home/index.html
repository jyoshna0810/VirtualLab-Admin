...
<head>
    ...
    <link rel="stylesheet" href="myques.css">
    ...
    <script defer src="ques.js"></script>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg fixed-top" role="navigation">
        <div class="container-fluid">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_fAzY7Sp4q7OHgp6lWMtSq-VKAQIjVHMp9xFoLW3e7GeQKcp2Q8PYCycNTN0CKjLx5io&usqp=CAU" alt="">
            <a class="navbar-brand" href="#" id="name">VirtualLabs</a>
            ...
            <div class="collapse navbar-collapse" id="exCollapsingNavbar">
                <ul class="nav navbar-nav mr-auto">
                    ...
                    <li class="nav-item" ><a href="myquestions.html" class="nav-link active" routerLink="/myarticle">My Questions</a></li>
    ...
    <div class="box">
        <div class="container" id="accordian">
            <div class="wrapper">
                <button class="toggle">Start with a Hello World!!!  <i class="fas fa-plus icon"></i></button>
                <div class="content">
