        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_fAzY7Sp4q7OHgp6lWMtSq-VKAQIjVHMp9xFoLW3e7GeQKcp2Q8PYCycNTN0CKjLx5io&usqp=CAU" alt="">
          ...
          <div class="collapse navbar-collapse" id="exCollapsingNavbar">
              <ul class="nav navbar-nav mr-auto">
                  ...
                  <li class="nav-item" ><a href="myquestions.html" class="nav-link" routerLink="/myarticle">My Questions</a></li>
                  
                  <li class="nav-item" ><a href="contribute.html" class="nav-link active">Contribute</a></li>
              </ul>
              <ul class="nav navbar-nav flex-row justify-content-between ml-auto">
                  <li class="nav-item" id="name"> <h2> </h2> </li>
            ...
            <fieldset >
              ...
              <fieldset class="form-group">
                <input class="form-control form-control-lg"
                  ...
                  type="text"
                  placeholder="Question Title" id="title" />
              </fieldset>
              ...
              <fieldset class="form-group">
                <textarea class="form-control"
                  ...
                  rows="8"
                  placeholder="Question Description" id="desc"></textarea>
              </fieldset>
              ...
              <button class="btn btn-lg pull-xs-right btn-primary" type="button" onclick="push()">
                Publish Question
              </button>
